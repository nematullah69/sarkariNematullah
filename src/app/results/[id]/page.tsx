...
  if (!result) {
    return {
      // ➡️ Updated Title for Not Found Page
...
      title: seoTitle,
      description: seoDesc,
      url: `https://governmentexam.online/results/${result.id}`, // ➡️ Updated URL
      siteName: "Government Exam", // ➡️ Updated Site Name
      images: [
        {
          url: result.imageUrl || "https://governmentexam.online/default-og-result.png", // ➡️ Updated URL
          width: 1200,
          height: 630,
          alt: result.examName,
        },
...
    },
    alternates: {
      canonical: `https://governmentexam.online/results/${result.id}`, // ➡️ Updated URL
    },
  };
}
...
      <ResultDetailsPageClient result={result} />
    </>
  );
}